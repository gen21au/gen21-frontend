...
export default function PrivacyPolicyPage() {
  const { data: pageData, isLoading, error } = useGetCustomPageQuery('privacy-policy');
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-red-600 mb-4">Error Loading Privacy Policy</h1>
          <p className="text-gray-600">Unable to load the privacy policy. Please try again later.</p>
        </div>
      </div>
    );
  }
